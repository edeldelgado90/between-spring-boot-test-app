...
public class GRPCPriceServiceIT {
  ...
  @Autowired private GRPCPriceService priceService;
  ...
  public void getCurrentPriceByProductAndBrandMustReturnValidPrice() {
    ...
    assertThat(response.getStartDate().getSeconds()).isEqualTo(1592247600);
    assertThat(response.getEndDate().getSeconds()).isEqualTo(1609469999);
